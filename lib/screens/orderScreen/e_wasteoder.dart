// ignore_for_file: camel_case_types, prefer_const_constructors, prefer_is_empty, unnecessary_new, non_constant_identifier_names
...
class E_WasteOrder_Screen extends StatefulWidget {
  const E_WasteOrder_Screen({super.key});

  @override
  State<E_WasteOrder_Screen> createState() => _E_WasteOrder_ScreenState();
}

class _E_WasteOrder_ScreenState extends State<E_WasteOrder_Screen> {
  final _formkey = GlobalKey<FormState>();
  CollectionReference ref = FirebaseFirestore.instance.collection('Posts');
  List<String> weight = ['0-5', '5-10', '10-20', '20-above'];
  String? selectedweight = '0-5';
  bool loading = false;
  String material = 'E-Waste';
                                ...
                                ref.add({
                                  ...
                                  showDialog(
                                    ...
                                    builder: (ctx) => AlertDialog(
                                      ...
                                      content:
                                          const Text("You Waste Registred"),
                                      actions: <Widget>[
                                        MaterialButton(
                                          color: Colors.black,
                                          onPressed: () {
