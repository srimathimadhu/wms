...
class Others_OrderScreen extends StatefulWidget {
  const Others_OrderScreen({super.key});

  @override
  State<Others_OrderScreen> createState() => _Others_OrderScreenState();
}

class _Others_OrderScreenState extends State<Others_OrderScreen> {
  ...
  Widget build(BuildContext context) {
    return loading
        ? Loading()
        : Scaffold(
            appBar: AppBar(title: Text('Other'),   backgroundColor: Color.fromARGB(255, 87, 188, 156),),
