...
class MedicalOrder_Screen extends StatefulWidget {
  const MedicalOrder_Screen({super.key});

  @override
  State<MedicalOrder_Screen> createState() => _MedicalOrder_ScreenState();
}

class _MedicalOrder_ScreenState extends State<MedicalOrder_Screen> {
  final _formkey = GlobalKey<FormState>();
  CollectionReference ref = FirebaseFirestore.instance.collection('Posts');
  List<String> weight = ['0-5', '5-10', '10-20', '20-above'];
  String? selectedweight = '0-5';
  bool loading = false;
  String material = 'Medical';
