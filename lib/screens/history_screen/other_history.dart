...
class Other_History extends StatefulWidget {
  const Other_History({super.key});

  @override
  State<Other_History> createState() => _Other_HistoryState();
}

class _Other_HistoryState extends State<Other_History> {
  //delete project
                ...
                child: TabBarView(children: <Widget>[
                  StreamBuilder(
                      stream: FirebaseFirestore.instance
                          .collection("Posts")
                          .where("Material", isEqualTo: "Other")
