...
class Construction_History extends StatefulWidget {
  const Construction_History({super.key});

  @override
  State<Construction_History> createState() => _Construction_HistoryState();
}

class _Construction_HistoryState extends State<Construction_History> {
  //delete project
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0,
        title: Text("Construction History"),
                ...
                child: TabBarView(children: <Widget>[
                  StreamBuilder(
                      stream: FirebaseFirestore.instance
                          .collection("Posts")
                          .where("Material", isEqualTo: "Construction")
