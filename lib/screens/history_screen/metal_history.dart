...
class Metal_History extends StatefulWidget {
  const Metal_History({super.key});

  @override
  State<Metal_History> createState() => _Metal_HistoryState();
}

class _Metal_HistoryState extends State<Metal_History> {
  //delete project
                ...
                child: TabBarView(children: <Widget>[
                  StreamBuilder(
                      stream: FirebaseFirestore.instance
                          .collection("Posts")
                          .where("Material", isEqualTo: "Metal")
