...
class Plastic_History extends StatefulWidget {
  const Plastic_History({super.key});

  @override
  State<Plastic_History> createState() => _Plastic_HistoryState();
}

class _Plastic_HistoryState extends State<Plastic_History> {
  //delete project
                ...
                child: TabBarView(children: <Widget>[
                  StreamBuilder(
                      stream: FirebaseFirestore.instance
                          .collection("Posts")
                          .where("Material", isEqualTo: "Plastic")
